<img width="953" height="802" alt="image" src="https://github.com/user-attachments/assets/236866bf-aada-41e3-a027-22cf10ed7b01" />

This image shows an Arduino Uno connected to multiple LEDs arranged in a straight line. Each LED is connected to a digital output pin through a current-limiting resistor, while the other terminals are connected to the ground rail on the breadboard. The setup is commonly used for creating LED animation patterns.
